...
add wave -noupdate -group Control -radix unsigned /UART_Wrapper_TB/DUT/control/ipTxReady
...
add wave -noupdate /UART_Wrapper_TB/PC/UART_Inst/ipTxData
add wave -noupdate /UART_Wrapper_TB/PC/UART_Inst/ipTxSend
add wave -noupdate /UART_Wrapper_TB/PC/UART_Inst/tx_state
add wave -noupdate /UART_Wrapper_TB/PC/UART_Inst/opTxBusy
...
add wave -noupdate -expand -group PC -radix hexadecimal -childformat {{/UART_Wrapper_TB/PC_RxPacket.Source -radix hexadecimal} {/UART_Wrapper_TB/PC_RxPacket.Destination -radix hexadecimal} {/UART_Wrapper_TB/PC_RxPacket.Length -radix hexadecimal} {/UART_Wrapper_TB/PC_RxPacket.SoP -radix hexadecimal} {/UART_Wrapper_TB/PC_RxPacket.EoP -radix hexadecimal} {/UART_Wrapper_TB/PC_RxPacket.Data -radix hexadecimal} {/UART_Wrapper_TB/PC_RxPacket.Valid -radix hexadecimal}} -expand -subitemconfig {/UART_Wrapper_TB/PC_RxPacket.Source {-height 15 -radix hexadecimal} /UART_Wrapper_TB/PC_RxPacket.Destination {-height 15 -radix hexadecimal} /UART_Wrapper_TB/PC_RxPacket.Length {-height 15 -radix hexadecimal} /UART_Wrapper_TB/PC_RxPacket.SoP {-height 15 -radix hexadecimal} /UART_Wrapper_TB/PC_RxPacket.EoP {-height 15 -radix hexadecimal} /UART_Wrapper_TB/PC_RxPacket.Data {-height 15 -radix hexadecimal} /UART_Wrapper_TB/PC_RxPacket.Valid {-height 15 -radix hexadecimal}} /UART_Wrapper_TB/PC_RxPacket
add wave -noupdate -expand -group PC -radix unsigned /UART_Wrapper_TB/PC/ipReset
