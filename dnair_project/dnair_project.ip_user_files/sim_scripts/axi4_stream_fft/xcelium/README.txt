...
#
# Generated by export_simulation on Fri May 27 19:32:30 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './axi4_stream_fft.sh' script.

./axi4_stream_fft.sh -reset_run
...
./axi4_stream_fft.sh -noclean_files

For more information on the script, please type './axi4_stream_fft.sh -help'.
