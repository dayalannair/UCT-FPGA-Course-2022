...
#
# Generated by export_simulation on Sat May 28 08:47:20 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './rom_data_Q.sh' script.

./rom_data_Q.sh -reset_run
...
./rom_data_Q.sh -noclean_files

For more information on the script, please type './rom_data_Q.sh -help'.
