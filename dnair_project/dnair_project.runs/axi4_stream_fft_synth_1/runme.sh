...
HD_PWD='C:/Users/Dayalan/Desktop/UCT-FPGA-Course-2022/dnair_project/dnair_project.runs/axi4_stream_fft_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi4_stream_fft.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi4_stream_fft.tcl
