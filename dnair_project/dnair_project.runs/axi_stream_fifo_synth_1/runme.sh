...
HD_PWD='C:/Users/Dayalan/Desktop/UCT-FPGA-Course-2022/dnair_project/dnair_project.runs/axi_stream_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_stream_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_stream_fifo.tcl
