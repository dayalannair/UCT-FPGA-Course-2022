...
HD_PWD='C:/Users/Dayalan/Desktop/UCT-FPGA-Course-2022/dnair_project/dnair_project.runs/rom_data_I_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_data_I.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_data_I.tcl
